...
import Search03Container from "../../../commons/search/03/Search03.container";
  ...
  const items: TabsProps["items"] = [
    {
      ...
      children: (
        <>
          <S.List>
            <Search03Container
              refetchSoldoutFalse={props.refetchSoldoutFalse}
              onChangeKeyword={props.onChangeKeyword}
            />
            {props.isSoldoutFalse?.map((el: any, index: any) => (
